...
public class Spawner : MonoBehaviour
{
    ...
    [SerializeField] private ObjectPooler AntPool;
    [SerializeField] private ObjectPooler BeetlePool;
    [SerializeField] private ObjectPooler WaspPool;
    [SerializeField] private ObjectPooler RoachPool;
    ...
    private void Awake()
    {
        ...
        {
            {EnemyType.Ant, AntPool},
            {EnemyType.Wasp, WaspPool},
            {EnemyType.Beetle, BeetlePool},
            {EnemyType.Roach, RoachPool},
